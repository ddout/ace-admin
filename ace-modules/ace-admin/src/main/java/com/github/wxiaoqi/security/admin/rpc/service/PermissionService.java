...
public class PermissionService {
  ...
  public void resetPassword(int id) {
    ...
    user.setPassword(encoder.encode("21218cca77804d2ba1922c33e0151105"));
    userBiz.updateById(user);
  }

  public void updatePassword(String token, String passwordOld, String passwordNew,
      String passwordNew2) throws Exception {
    String username = userAuthUtil.getInfoFromToken(token).getUniqueName();
    if (username == null) {
