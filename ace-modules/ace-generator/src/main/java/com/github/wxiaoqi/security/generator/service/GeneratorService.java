...
public class GeneratorService {
	...
	public byte[] generatorCode(String[] tableNames, String package_,String sysname, String modulname) {
		...
		for(String tableName : tableNames){
			...
			//生成代码
			GeneratorUtils.generatorCode(table, columns, zip,package_, sysname, modulname);
		}
